...
export const GET_PRODUCT_MODELS_BY_PROFILE = 'api/products/models/find-by-profile';
...
export const FIND_DETAILED_PRODUCT_MODEL = (reference) => `api/products/models/find/${reference}/all`;
