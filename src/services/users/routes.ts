...
export const FIND_BY_EMAIL = "api/socialnetworks/users/self/find-by-email";
...
export const GET_RESILIATED_USERS = "api/socialnetworks/users/self/resiliations";
...
export const RESILIATE_USER = (reference) => `api/socialnetworks/users/self/${reference}/resiliations`;
export const RESTORE_RESILIATE_USER = (reference) => `api/socialnetworks/users/self/${reference}/resiliations/cancel`;
