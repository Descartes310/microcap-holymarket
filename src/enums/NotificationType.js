...
export default class NotificationType extends BaseEnum {
    ...
    static INJECTION_REQUEST = 'INJECTION_REQUEST';
    static OPERATION_RECEIPT = 'OPERATION_RECEIPT';
    static COMMUNITY_INVITATION = 'COMMUNITY_INVITATION';
    static DEDICATED_GRANT_OFFER = 'DEDICATED_GRANT_OFFER';
    static FILE_AUTHENTIFICATION = 'FILE_AUTHENTIFICATION';
