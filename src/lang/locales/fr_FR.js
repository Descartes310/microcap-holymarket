module.exports = {
   ...
   "components.commercialName" : "Nom commercial",
   "components.corporateName" : "Nom de l'organisation",
   ...
   "components.mobileNumber": "Numéro de portable (avec indicateur, ex: +237)",
   "components.address2Optional": "Adresse de facturation 2 (facultatif)",
   "components.country": "Pays",
   "components.zip": "Code postal",
   ...
   "branch.field.licenseNumber": "Numéro de licence de la branche",
   "branch.field.pfmshipLimit": "Limite PFM",
   "branch.field.membershipLimit": "Limite d'adhésion",
   "branch.field.partnershipLimit": "Limite de partenariat",
   "branch.field.signature": "Signature {number}",
   "branch.field.representativePosition": "Position du représentant légal",
   "branch.field.logo": "Logo",
   "branch.field.type": "Type",
   "branch.field.designation": "Designation",
   "branch.field.compulsoryAssistant": "Assistant obligatoire",
   "branch.field.othersAssistant": "Autre assistant",
   "branch.field.partnership": "Partenariat",
   "branch.field.partnershipType": "Type de partenariat",
   "branch.field.partnership.empty": "Vous devez créer un partenariat avant de continuer",
   "branch.field.partnershipType.empty": "Vous devez créer un type de partenariat avant de continuer",
   "branch.field.contractNumber": "N° Contrat",
   ...
   "branch.profile": "Profil de branche",
   "branch.primary": "Branche primaire",
   "branch.assistantConfiguration": "Configuration de l'assistant",
   "branch.createNewNetworkProfile": "Créer un nouveau profil réseau",
   "branch.profile.create.successText": "Nouveau profil réseau créé avec succès",
   "branch.partnership.create.successText": "Nouveau partenariat créé avec succès",
   "branch.assistantConfiguration.create.successText": "Nouveau partenariat créé avec succès",
   "branch.declareMentorship": "Déclarer un mentorat",
   "branch.withParent": "Avec profil parent",
   "branch.withoutParent": "Sans profil parent",
   "branch.found": "{count} branche(s) trouvées",
   "branch.configuration.open.text": "Configurer la structure de votre réseau {name}",
   "branch.configuration.open.successText": "La configuration de votre a debuté",
   ...
   "network.step.1.label": "Informations de base sur le réseau",
   "network.step.2.label": "Opérateur",
   "network.step.3.label": "Représentant légal",
   "network.step.3.labelCount": "Représentant légal N°{count}",
   "network.field.name": "Nom du réseau",
   "network.field.link": "Lien réseau",
   "network.field.licenseNumber": "Numéro de licence réseau",
   "network.field.pfmshipLimit": "Limite PFM",
   "network.field.membershipLimit": "Limite d'adhésion",
   "network.field.partnershipLimit": "Limite de partenariat",
   "network.field.signature": "Signature {number}",
   "network.field.representativePosition": "Position du représentant légal",
   "network.field.logo": "Logo",
   "network.field.type": "Type",
   "network.field.designation": "Désignation",
   "network.field.compulsoryAssistant": "Assistant obligatoire",
   "network.field.othersAssistant": "Autres assistants",
   "network.field.partnership": "Partenariat",
   "network.field.partnershipType": "Type de partenariat",
   "network.field.partnership.empty": "Vous devez créer un partenariat avant de continuer",
   "network.field.partnershipType.empty": "Vous devez créer un type de partenariat avant de continuer",
   "network.field.contractNumber": "Numéro de contrat",
   "network.form.successCreation": "Réseau créé avec succès",
   "network.alert.deleteText": "Souhaitez-vous vraiment supprimer ce représentant légal avec tous ses champs?",
   "network.alert.deleteTitle": "Supprimer confirmer",
   "network.maxMemberNumber": "Numéro de membre",
   "network.maxPartnerNumber": "Numéro de partenaire",
   ...
   "network.partnership.create.successText": "Nouveau partenariat créé avec succès",
   "network.assistantConfiguration.create.successText": "Nouveau partenariat créé avec succès",
   "network.declareMentorship": "Déclarer un mentorat",
   "network.withParent": "Avec profil parent",
   "network.withoutParent": "Sans profil parent",
   "network.configuration.open.text": "Configurer la structure de votre réseau {name}",
   "network.configuration.open.successText": "La configuration de votre a debuté",
   ...
   "projects.configuration.standard.presentation.found": "{count, plural, =0 {Aucun présentation trouvés} one {1 présentation trouvé} other { {count} présentations trouvés}}",
   ...
   "projects.configuration.initialisation.projects_call.found": "{count, plural, =0 {Aucune appel à projets trouvés} one {1 appel à projets trouvé} other { {count} appel à projets trouvés}}",
