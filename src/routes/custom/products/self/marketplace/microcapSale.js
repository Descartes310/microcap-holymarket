...
class MicrocapProduct extends Component {
    ...
    componentDidMount() {
        this.props.getProducts(this.props.authUser.user.branch.id, 'MICROCAP_PRODUCT');
    }
...
(withStyles(useStyles, { withTheme: true })(withRouter(injectIntl(MicrocapProduct))));
