...
import {createMandateType, getMandateType} from "Actions";
...
const Create = props => {
    ...
    const { classes, getMandateType, authUser, loading, intl, onClose, show, setRequestGlobalAction } = props;
    ...
    const onSubmit = (data) => {
        ...
        createMandateType(data, authUser.user.branch.id)
            .then(() => {
                NotificationManager.success("Type de mandat crée avec succès");
