...
const Create = (props) => {
    ...
    const onSubmit = () => {
        ...
        var data: any = {
            label, description, politic_reference: politic.reference, values: JSON.stringify(values.map(v => {return {reference: v.setting.reference, value: v.value, label: v.label}}))
        }
