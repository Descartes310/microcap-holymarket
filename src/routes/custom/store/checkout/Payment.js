...
class PaymentInfo extends Component {
    ...
    */
   confirmPayment() {
      this.props.onComplete(this.state, false);
      ...
      return (
         <div className="payment-wrap">
            ...
            <div className="w-80 mx-auto">
               ...
               <div className="d-flex justify-content-between">
                  <Button onClick={this.props.onBack} color="secondary" className="text-white" variant="contained">
