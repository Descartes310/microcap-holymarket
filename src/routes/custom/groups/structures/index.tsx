...
class Structures extends Component<any, any> {
    ...
    render() {
        ...
        return (
            <div>
                <PageTitleBar title={"Structure organisation"} match={this.props.match} />
                <RctCard>
...
export default connect(mapStateToProps, { setRequestGlobalAction })(withRouter(Structures));