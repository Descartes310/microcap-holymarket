...
import { translateStructureMissionTypes } from 'Helpers/datas';
...
const List = (props) => {
    ...
    const goToCreate = () => {
        props.history.push(GROUP.STRUCTURE.MISSION.CREATE);
    }
                                        ...
                                        {list && list.map((item, key) => (
                                            <tr key={key} className="cursor-pointer">
                                                ...
                                                <td>
                                                    <div className="media">
                                                        <div className="media-body pt-10">
                                                            <h4 className="m-0 fw-bold text-dark">{translateStructureMissionTypes(item.type)}</h4>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
