...
const GroupOptionTypes = (props) => {
    ...
    const [groupOptionTypes, setGroupOptionTypes] = useState([]);
    ...
    const getGroupOptionTypes = () => {
        props.setRequestGlobalAction(true),
        GroupService.getGroupOptionTypes(reference)
        .then(response => setGroupOptionTypes(response))
        .finally(() => props.setRequestGlobalAction(false))
    }
    ...
    const onSubmit = () => {        
        ...
        props.setRequestGlobalAction(true);
        GroupService.createGroupOptionTypes(reference, data).then(() => {
    ...
    const onDelete = (item) => {
        ...
        props.setRequestGlobalAction(true);
        GroupService.deleteGroupOptionTypes(reference, data).then(() => {
