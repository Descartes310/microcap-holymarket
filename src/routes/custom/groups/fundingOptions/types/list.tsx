...
const List = (props) => {
    ...
    const goToCreate = () => {
        props.history.push(GROUP.FUNDING_OPTION.TYPE.CREATE);
    }
                                ...
                                <table className="table table-hover table-middle mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th className="fw-bold">Structurel</th>
                                        ...
                                        {list && list.map((item, key) => (
                                            <tr key={key} className="cursor-pointer">
                                                ...
                                                <td>
                                                    <div className="media">
                                                        <div className="media-body pt-10">
                                                            <h4 className="m-0 fw-bold text-dark">{item.structural ? 'OUI' : 'NON'}</h4>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <div className="media">
                                                        <div className="media-body pt-10">
                                                            <h4 className="m-0 fw-bold text-dark">{item?.category?.label}</h4>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
