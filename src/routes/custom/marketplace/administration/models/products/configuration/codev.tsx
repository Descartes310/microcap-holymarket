...
const Codev = (props) => {
    ...
    const [quotienAvailable, setQuotientAvailable] = useState(null);
    ...
    return (
        <>
            ...
            <div className="row">
                <FormGroup className="col-md-6 col-sm-12 has-wrapper">
                    <InputLabel className="text-left" htmlFor="quotienAvailable">
                    ...
                    <InputStrap
                        ...
                        className="input-lg"
                        id="quotienAvailable"
                        name='quotienAvailable'
                        value={quotienAvailable}
...
export default connect(() => {}, { setRequestGlobalAction })(withRouter(Codev));