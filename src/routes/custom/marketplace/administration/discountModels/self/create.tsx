...
const Create = (props) => {
    ...
    const onSubmit = () => {
        ...
        ProductService.createDiscountModel(data).then(() => {
            NotificationManager.success('Le coupon a été créé avec succès');
            props.history.push(MARKETPLACE.DISCOUNT_MODELS.LIST);
        })
        .catch((err) => {
            console.log(err);
