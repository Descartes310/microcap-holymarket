        ...
        return (
            <div className="profile-top mb-20">
                ...
                <div className="profile-content">
                    <div className="media">
                    <div><img src={this.props.userAvatar ? 'https://'+this.props.userAvatar : require('Assets/avatars/profile.jpg')} alt="user profile" className="rounded-circle mr-30 bordered" width="140" height="140" />
