...
import {getUserProfiles, setRequestGlobalAction, setActiveCatalog} from "Actions";
    ...
    handleActiveConfirmed = () => {
        ...
        setActiveCatalog(this.state.catalogId)
            .then(result => {
                ...
                this.props.getUserProfiles(Product.PRODUCT);
                    ...
                    : (
                        <>
                            <AppBar position="static" className="bg-white px-0 mx-0">
                                <Toolbar>
                                    ...
                                    <p className={classes.title}>
                                        {orderedItems.length} profile(s) trouvé(s)
                                    </p>
                                </Toolbar>
                            </AppBar>
                            <UserProfileCreate
                            ...
                            {orderedItems.length === 0
                                ? (
                                    <RctCollapsibleCard>
                                        Aucun profile utilisateur trouvés
                                    </RctCollapsibleCard>
                                )
                                : (
                                    <>
