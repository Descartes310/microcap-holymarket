...
class LiquidOPMCMOperationModal extends Component {
            ...
            >
                <FormGroup className="has-wrapper">
                    <InputLabel className="text-left" htmlFor="reference">
                        Reference de liquidation OPMCM
                    </InputLabel>
                    <InputStrap
                        required
                        type="text"
...
export default connect(() => {}, { setRequestGlobalAction })(withRouter(injectIntl(LiquidOPMCMOperationModal)));