...
class Moneys extends Component<any, any> {
    ...
    render() {
        ...
        return (
            <div>
                <PageTitleBar title={"Monnaie de service"} match={this.props.match} />
                <RctCard>
...
export default connect(mapStateToProps, { setRequestGlobalAction })(withRouter(Moneys));