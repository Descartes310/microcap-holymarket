...
const Users = (props) => {
    ...
    const getCampaigns = () => {
        ...
        GroupService.getSupervisedCampaigns()
            .then(response => {
                setDatas(response);
            })
            .catch(err => {
        ...
        <>
                        ...
                        {list && list.length === 0 ? (
                            ...
                            <div className="table-responsive">
                                <table className="table table-hover table-middle mb-0">
                                    <thead>
                                        <tr>
                                            <th className="fw-bold">Structure financière</th>
                                                ...
                                                <td>
                                                    <div className="media">
                                                        <div className="media-body pt-10">
                                                            <h4 className="m-0 fw-bold text-dark">{item.structureName}</h4>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
            ...
            { selectedData && showConfirmBox && (
                <ConfirmBox
                    show={showConfirmBox}
                    rightButtonOnClick={() => {
                        changeProgression(selectedData, false);
                    }}
                    leftButtonOnClick={() => {
