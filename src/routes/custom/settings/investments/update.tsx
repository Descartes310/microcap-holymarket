...
const Update = (props) => {
    ...
    const findData = () => {
        ...
        SettingService.findInvestmentSetting(props.match.params.id).then((response) => {
            setLabel(response.label);
            setType(getInputTypes().find(d => d.value == response.formInputType));
            setPerimeter(getInvestmentPerimeterTypes().find(d => d.value == response.perimeter));
        })
        .catch((err) => {
            console.log(err);
    ...
    const onSubmit = () => {
        ...
        SettingService.updateInvestmentSetting(props.match.params.id, data).then(() => {
            NotificationManager.success('Paramètre édité avec succès');
    ...
    return (
        <>
            <PageTitleBar
                title={"Edition d'un paramètre d'investissement"}
            />
            <RctCollapsibleCard>
