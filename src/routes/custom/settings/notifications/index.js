    ...
    render() {
        ...
        return (
            <div className="full-height">
                <>
                    <Switch>
                        <Redirect exact from={`${match.url}/`} to={SETTINGS.NOTIFICATION.LIST} />
                        <Route path={SETTINGS.NOTIFICATION.LIST} component={List} />
                        <Route path={SETTINGS.NOTIFICATION.CREATE} component={Create} />
                        {/*<CanRoute
