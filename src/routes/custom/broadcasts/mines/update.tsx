...
const Create = (props) => {
    ...
    const findBroadcast = () => {
        ...
        MessageService.findBroadcast(props.match.params.id).then((response) => {
            setLabel(response.title);
            setDescription(response.description);
            setType(broadcastTypes().find(c => c.value === response.type));
            setContactType(contactTypes.find(c => c.value === response.contactType));
        })
        .catch((err) => {
            console.log(err);
    ...
    const onSubmit = () => {
        ...
        MessageService.updateBroadcast(props.match.params.id, data).then(() => {
            NotificationManager.success('Liste éditée avec succès');
