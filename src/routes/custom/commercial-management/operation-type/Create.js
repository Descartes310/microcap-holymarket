...
const Create = props => {
    ...
    const { authUser, loading, intl, onClose, show, setRequestGlobalAction, getComOperationType } = props;
...
export default connect(mapStateToProps, {getComOperationType, getUserPermissions, setRequestGlobalAction })
