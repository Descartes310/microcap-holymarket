...
import { BROKER, joinUrlWithParamsId, FUNDING, joinUrlWithParams } from 'Url/frontendUrl';
...
const List = (props) => {
    ...
    const updateItem = (item) => {
        props.history.push(joinUrlWithParams(BROKER.AGENCY.UPDATE, [{param: 'id', value: item.reference}]));
    }
