...
class Read extends Component {
    ...
    componentDidMount() {
        this.props.getAllNotifications(this.props.authUser.user.id, 'READ');
                    ...
                    <div className="table-responsive">
                        ...
                        <>
                            {notifications.length === 0 ? (
                                <SingleTitleText
                                    text="Pas de notifications lues pour le moment"
                                />
                            ) : (
                            ...
                            <div className="col-md-12">
                                ...
                                <div className='mt-40' style={{ display: 'flex', justifyContent: 'space-around', alignItems: 'center' }}>
                                    ...
                                    <Button
                                        ...
                                        href={this.state.notif ? getFilePath(this.state.notif.userPiece.file) : null}
                                        target="_blank"
                                        download
                                    >
                                        Télecharger
...
export default connect(mapStateToProps, { getAllNotifications, setRequestGlobalAction })(Read);
