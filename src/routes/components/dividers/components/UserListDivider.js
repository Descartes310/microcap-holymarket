...
const ListDivider = () => (
  <Scrollbars className="rct-scroll" autoHeight autoHeightMin={100} autoHeightMax={350}>
    <List className="p-0 list-divider">
      <ListItem button>
        <Avatar alt="user 1" className="img-fluid" src={require('Assets/img/profile.jpg')} />
      ...
      <ListItem button>
        <Avatar alt="user 2" className="img-fluid" src={require('Assets/img/profile.jpg')} />
      ...
      <ListItem button>
        <Avatar alt="user 3" className="img-fluid" src={require('Assets/img/profile.jpg')} />
      ...
      <ListItem button>
        <Avatar alt="user 4" className="img-fluid" src={require('Assets/img/profile.jpg')} />
      ...
      <ListItem button>
        <Avatar alt="user 5" className="img-fluid" src={require('Assets/img/profile.jpg')} />
