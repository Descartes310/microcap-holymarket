...
import AddSegragatedAccountModel from './AddSegragatedAccountModel';


const SegragatedAccount = (props) => {
...
export default connect(() => {}, { setRequestGlobalAction })(withRouter(SegragatedAccount));
