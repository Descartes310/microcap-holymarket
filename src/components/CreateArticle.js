...
import CreateArticleTopic from './CreateArticleTopic';
...
const CreateArticle = (props) => {
    ...
    const getTopics = () => {
        props.setRequestGlobalAction(true);
        SettingService.getBlogTopics(false, props.personal).then((response) => {
            setTopics(response);
        }).catch((err) => {
            setTopics([]);
        }).finally(() => {
                    ...
                    <Autocomplete
                        ...
                        onChange={(event, newValue) => {
                            ...
                            setTimeout(() => {
                                ...
                                setTopicTitle(newValue);
                            });
                            } else if (newValue && newValue.inputValue) {
                                setShowCreateTopic(true);
                                setTopicTitle(newValue.inputValue)
                            } else {
                            setTopic(newValue);
                            }
                        }}
...
export default connect(() => {}, { setRequestGlobalAction })(withRouter(CreateArticle));