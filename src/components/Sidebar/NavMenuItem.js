...
class NavMenuItem extends Component {
   ...
   */
   ...
   render() {
      ...
      if ((menu.key != 'commnity_admin') || (menu.key == 'commnity_admin' && this.props.communitySpace.admins.includes(authUser.user.id)))
...
export default connect(mapStateToProps, { statusCommunitySpaceStatus })
   (withStyles(styles, { withTheme: true })(NavMenuItem));
